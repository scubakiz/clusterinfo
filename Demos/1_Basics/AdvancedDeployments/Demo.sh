...
read -p "Demo Step - Creates new green workload"
kubectl apply -k ./step1

read -p "Demo Step - Switches the service to new workload"
...
read -p "Demo Step - Switches back to blue workload."
kubectl apply -k ./step3

read -p "Demo Step - Deletes green workload.  This will force all browsers to switch to the blue image".
